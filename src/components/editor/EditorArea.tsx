...
const EditorArea = forwardRef<EditorAreaHandle, EditorAreaProps>(
  ({ onChange, onSelectionChange, placeholder = "Start writing...", initialContent, onSourceModeChange }, ref) => {
    ...
    const gutterWidth = Math.max(3, String(sourceLineCount).length) * 10 + 16;
    ...
    return (
      ...
      {sourceMode && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60">
          <div className="flex flex-col w-[90vw] max-w-[1100px] h-[85vh] bg-editor-surface border border-border rounded-lg shadow-2xl overflow-hidden">
            {/* Modal header */}
            <div className="flex items-center justify-between px-5 py-3 bg-toolbar border-b border-border">
